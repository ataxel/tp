...
class __TwigTemplate_b147ea891e2e3a303af9ff5c82a17f8f5b0661124f5bb481ea5d6f592e182af2 extends eZ\Bundle\EzPublishDebugBundle\Twig\DebugTemplate
{
    ...
    <div class=\"span12\">
        ...
        // line 41
        echo "        ";
        if ($this->getAttribute($this->getAttribute((isset($context["zones"]) ? $context["zones"] : $this->getContext($context, "zones")), 2, array(), "array"), "blocks", array())) {
            // line 42
            echo "            ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["zones"]) ? $context["zones"] : $this->getContext($context, "zones")), 2, array(), "array"), "blocks", array()));
            $context['loop'] = array(
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
