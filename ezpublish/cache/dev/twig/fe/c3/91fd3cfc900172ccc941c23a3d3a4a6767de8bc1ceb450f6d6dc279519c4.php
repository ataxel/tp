...
class __TwigTemplate_fec391fd3cfc900172ccc941c23a3d3a4a6767de8bc1ceb450f6d6dc279519c4 extends eZ\Bundle\EzPublishDebugBundle\Twig\DebugTemplate
{
    ...
    {
        // line 4
        $context["several"] = (twig_length_filter($this->env, (isset($context["valid_items"]) ? $context["valid_items"] : $this->getContext($context, "valid_items"))) > 1);
        // line 5
        echo "<!-- BLOCK: START -->
<div class=\"block-type-campaign\">
    <div class=\"campaign\">
        ...
        // line 10
        echo "        <a href=\"";
        echo twig_escape_filter($this->env, (((isset($context["several"]) ? $context["several"] : $this->getContext($context, "several"))) ? ($this->env->getExtension('routing')->getPath("ez_urlalias", array("locationId" => $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "locationId", array())))) : ("#")), "html", null, true);
        echo "\" class=\"navig next";
        if ((!(isset($context["several"]) ? $context["several"] : $this->getContext($context, "several")))) {
            echo " disabled";
        }
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["valid_contentinfo_items"]) ? $context["valid_contentinfo_items"] : $this->getContext($context, "valid_contentinfo_items")));
        $context['loop'] = array(
