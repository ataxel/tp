...
class __TwigTemplate_53465fda8c54c155033f2fdf870daa4269dec0c5e65afb5b14e1f2b8ab6d7380 extends eZ\Bundle\EzPublishDebugBundle\Twig\DebugTemplate
{
    ...
    public function block_ez_legacy_render_js($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["js_files"]) ? $context["js_files"] : $this->getContext($context, "js_files")));
    ...
    ";
        // line 7
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["js_code_lines"]) ? $context["js_code_lines"] : $this->getContext($context, "js_code_lines")));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 8
